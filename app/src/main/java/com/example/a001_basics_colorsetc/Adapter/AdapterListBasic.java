package com.example.a001_basics_colorsetc.Adapter;
...
public class AdapterListBasic extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Books obj, int position);
    }
    ...
    public AdapterListBasic(Context context, List<Books> items) {
        this.items = items;
        ctx = context;
    }
